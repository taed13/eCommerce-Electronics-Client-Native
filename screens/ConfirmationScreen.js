...
const ConfirmationScreen = () => {
  ...
  const total = cart && cart?.map((item) => item.price * item.quantity).reduce((curr, prev) => curr + prev, 0);
              ...
              addresses?.map((item, index) => (
                ...
                >
                  {selectedAddress && selectedAddress._id === item?._id ? (
                    ...
                    <Entypo onPress={() => setSelectedAdress(item)} name="circle" size={20} color="gray" />
                  )}
      ...
      {currentStep == 1 && (
        <View style={{ marginHorizontal: 20 }}>
          ...
          >
            ...
            <Text style={{ flex: 1 }}>
              <Text style={{ color: "green", fontWeight: "500" }}>Tomorrow by 10pm</Text> - FREE delivery with your
              Prime membership
            </Text>
          </View>
