import { Text, View, ScrollView, Pressable, TextInput, ImageBackground, Dimensions } from "react-native";
    ...
    <ScrollView style={{ marginTop: 55, flex: 1, backgroundColor: "white" }} showsVerticalScrollIndicator={false}>
      ...
      <View style={{ padding: 10 }}>
        ...
        >
          ...
          <Text style={{ fontSize: 15, fontWeight: "500" }}>Deliver To Sujan - Bangalore 560019</Text>
        </View>
      </View>
